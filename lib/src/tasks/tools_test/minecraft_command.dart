...
class MinecraftCommand {
  ...
  static Future<List<String>> getlaunchCommand( Map versiondata, String path) async {
    List command = [];
    ...
    List<String> returncommand = await overrideArguments(command, versiondata, path);
...
//MARK: Arguments Override
  ...
  static Future<List<String>> overrideArguments(
      List<dynamic> command, Map versionData, String path) async {
