...
class SvgButton extends StatefulWidget {
  SvgButton.asset(this.asset, {Key? key, required this.onpressed, this.color}) : super(key: key);
  String asset;
  Color? color;
        ...
        child: MouseRegion(
          child: SvgPicture.asset(widget.asset,
              color: (widget.color ?? Theme.of(context).colorScheme.primary)
                  .withOpacity(Tween(begin: 1, end: 0.5).animate(_controller).value.toDouble())),
