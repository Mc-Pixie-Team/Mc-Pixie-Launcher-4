...
class Api {
  ...
  Future<Map> getMMLVersion(modpackVersion, String instanceName, String modloader) {
    throw Exception(
        "Do not call the normal API class, this is just a Template function!");
  }

  //This method should change the API query to add
  // a specific tag or category (ex: technology, magic) to it
  ...
  Future<List> getMoreModpacks() {     throw Exception(
        "Do not call the normal API class, this is just a Template function!"); }
  ...
  //should return a modpack based of the version ID that is given
 Future<Map<String, dynamic>> getModpackVersion(String version) {
    throw Exception(
        "Do not call the normal API class, this is just a Template function!");
  }
