        ...
        child:  Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text("Add Mods", textAlign: TextAlign.center,)
            ],
          ),
        )),
      ]),
              ...
              builder: (context, _scrollController, physics) =>
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          margin: EdgeInsets.only(left: 38, right: 49,),
                          ...
                          child: ModItem(name: current.name ?? "", downloads: current.downloads, author: current.author,) ,
                        );
                      })))
    ]);
  }
