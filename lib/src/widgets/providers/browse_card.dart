              ...
              children: [
                Padding(
                  ...
                  child: Container(
                      ...
                      clipBehavior: Clip.antiAlias,
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(18), color: Theme.of(context).colorScheme.surfaceVariant),
                      ...
                      children: [
                        ...
                        Text(
                          widget.modpackData.likes! > 999
                              ? (((widget.modpackData.likes! / 1000) as double).round()).toString() + 'k'
                              : widget.modpackData.likes!.toString(),
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 15,
                            fontFamily: 'Roboto',
                        ...
                        Text(
                          widget.modpackData.downloads! > 999
                              ? (((widget.modpackData.downloads! / 1000) as double).round()).toString() + 'k'
                                ...
                                child: ListView.separated(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Padding(
                                          ...
                                          child: Text(
                                            capitalize(widget.modpackData.categories![index]),
                                            style: TextStyle(
                                    ...
                                    separatorBuilder: (context, index) {
                                      return Container(
                                        ...
                                        height: 5.0,
                                        decoration: BoxDecoration(
                                            shape: BoxShape.circle, color: Theme.of(context).colorScheme.outline),
                                      );
                                    },
                                    itemCount: widget.modpackData.categories!.length)))
                      ],
                    ),
                    SizedBox(
                      height: 20,
      ...
      child: TweenAnimationBuilder<double>(
        ...
        builder: (context, progress, child) {
          return CircularProgressIndicator(
            backgroundColor: isDownloading ? Theme.of(context).colorScheme.outline : Colors.white.withOpacity(0),
