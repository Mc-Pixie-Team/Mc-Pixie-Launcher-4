...
__attribute__((visibility("default"))) int zipext(char *zipname, char *outputDir) {
...
__attribute__((visibility("default"))) int fileext(char *zipname, char *innerPath, char *outputPath) {
