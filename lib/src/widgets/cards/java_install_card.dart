...
class _JavaInstallCardState extends State<JavaInstallCard> {
  ...
  bool get isDownloading => _downloader.downloadstate == DownloadState.customDownload;

  int installStep = 1;
  int stepAmount = 2;

  install() async {
    List<int> _bytes = await _downloader
    ...
    _bytes = [];
    installStep++;
    _bytes = await _downloader
        .downloadSingeFileAsBytes("https://cdn.azul.com/zulu/bin/zulu17.44.53-ca-jdk17.0.8.1-win_x64.zip");
  ...
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(
            boxShadow: [BoxShadow(color: Color.fromARGB(90, 0, 0, 0), blurRadius: 16)],
