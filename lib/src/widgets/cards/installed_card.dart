...
class _InstalledCardState extends State<InstalledCard> {
  ...
  Widget iconhandler() {
    ...
    if (widget.controllerInstance.modpackData.icon != null) {
      return FadeInImage.memoryNetwork(
          ...
          image: widget.controllerInstance.modpackData.icon!);
    }

    return Image.memory(
      File(path.join(getInstancePath(), widget.controllerInstance.processId,
              "icon.png"))
          .readAsBytesSync(),
  ...
  onExport() {
    showGeneralDialog(
        ...
        transitionBuilder: (context, anim1, anim2, child) {
          Animation<double> ani = CurvedAnimation(
              parent: anim1,
  ...
  onOpen(BuildContext context) {
    if (widget.controllerInstance.installModel.installState ==
        InstallState.installing) return;
    Navigator.push(
        context,
                                                                    ...
                                                                    ? Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Padding(
                                                                              ...
                                                                              child: Container(height: double.infinity, width: 1, color: Theme.of(context).colorScheme.outline)),
                                                                          SvgButton.asset(
                                                                              'assets/svg/export-import-icon.svg',
                                                                              onpressed: onExport),
                                                                          SvgButton.asset(
